...
public class ExampleServlet1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		 ...
		 *  - 클라이언트 요청 시 생성되는 객체
		 *  
		 *  - 서버가 클라이언트에게 응답 할 수 있는 
		 * 	  방법을 제공하는 객체
		 * 
		 *  - 서버 -> 클라이언트롤 연결된 출력용 스트림 제공
		 *   (PrintWriter)
		 */
		...
		// -> MIME Type :
		//	 인터넷으로 전달되는 데이터/파일의 형식을 구분 하는 것
		...
		sb.append("<img src = https://images.samsung.com/kdp/goods/2023/07/12/c7fc047b-fe7f-44ab-ad8a-7105b4f35abc.png?$PD_GALLERY_L_PNG$ width = 100px, height = 100px>");
		sb.append("<ul>");
